...
const translations = {
  es: {
    ...
    home_cta_desc: "Consulte de forma interactiva cualquier capítulo, artículo o propuesta técnica oficial sin riesgo de alucinaciones usando el motor inteligente Gemini 3.1 Flash-Lite.",
    home_cta_btn: "Abrir Asistente IA",
    assistant_welcome_title: "Asistente Técnico de la Estrategia",
    assistant_welcome_desc: "Realice consultas sobre los diagnósticos, cuellos de botella y propuestas técnicas oficiales de la Estrategia de Financiamiento para el Desarrollo.",
    ...
    notebook_faq_item1: "¿Cuáles son las principales propuestas en materia de financiamiento verde y taxonomía nacional?",
  ...
  en: {
    ...
    home_cta_desc: "Interactively query any official chapter, article, or technical proposal without risk of hallucinations using the Gemini 3.1 Flash-Lite intelligent engine.",
    home_cta_btn: "Open AI Assistant",
    assistant_welcome_title: "Technical Assistant of the Strategy",
    assistant_welcome_desc: "Perform queries on the official diagnostics, bottlenecks, and technical proposals of the Development Financing Strategy.",
    ...
    notebook_faq_item1: "What are the main proposals regarding green financing and national taxonomy?",
